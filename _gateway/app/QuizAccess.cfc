/**
 * @Author Jj Zettler
 * @Description This will be the access point for the Quiz table.
 * @date 9/21/2023
 * @version 0.1
 * @FindOBJECT Quiz
 * @FindCOLUMNS t.id
...
<cfcomponent output="false" extends="BaseAccess">
	...
	<cffunction name="create" access="package" returntype="boolean" output="false" hint="Adds a new entry into the database.">
		<cfargument name="entity" type="QuizDTO" required="true">
		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				VALUES (
					...
					,<cfqueryparam  value="#entity.getQuizId()#"  cfsqltype="cf_sql_varchar">
					,<cfqueryparam  value="#entity.getQuizData()#"  cfsqltype="cf_sql_varchar">
				)
			</cfquery>

			<cfcatch type="any">
				<cfset var message = {
					"customMessage": "Error occurred in Quiz Access CREATE.",
	...
	<cffunction name="updateById" access="package" returntype="boolean" output="false" hint="Updates an entry based on the id provided and the new Content">
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage": "Error occurred in Quiz Access UPDATE.",
					"errorMessage": "#cfcatch.message#" }>
	...
	<cffunction name="get" access="package" returntype="any" output="false" hint="Gets an entity by the key-value pairs provided">
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage": "Error occurred in Quiz Access GET.",
					"errorMessage": "#cfcatch.message#" }>
	...
	>
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage" : "Error occurred in Quiz Access GETBYCREATIONDATE.",
					"errorMessage"  : "#cfcatch.message#"
				}>
