/**
 * @Author Jj Zettler
 * @Description This will be the access point for the LearningCategory table.
 * @date 9/21/2023
 * @version 0.1
 * @FindOBJECT LearningCategory
 * @FindCOLUMNS t.id
 * ,t.created_on
 * ,t.modified_on
 * ,t.active
...
<cfcomponent output="false" extends="BaseAccess">
	...
	<cffunction name="create" access="package" returntype="boolean" output="false" hint="Adds a new entry into the database.">
		<cfargument name="entity" type="LearningCategoryDTO" required="true">
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage": "Error occurred in LearningCategory Access CREATE.",
	...
	<cffunction name="updateById" access="package" returntype="boolean" output="false" hint="Updates an entry based on the id provided and the new Content">
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage": "Error occurred in LearningCategory Access UPDATE.",
					"errorMessage": "#cfcatch.message#" }>
	...
	<cffunction name="get" access="package" returntype="any" output="false" hint="Gets an entity by the key-value pairs provided">
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage": "Error occurred in LearningCategory Access GET.",
					"errorMessage": "#cfcatch.message#" }>
	...
	>
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfset var message = {
					"customMessage" : "Error occurred in LearningCategory Access GETBYCREATIONDATE.",
					"errorMessage"  : "#cfcatch.message#"
				}>
